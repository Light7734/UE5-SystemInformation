...
namespace SystemInfo {
	...
	TArray<FHardDisk::Info> FHardDisk::FetchInfo()
	{
		// query hard disks
	...
	void FHardDisk::TryFetchField(const FString& iter, const char* fieldName, FString& outValue)
	{
	...
	void FHardDisk::TryFetchArrayField(const FString& iter, const char* fieldName, TArray<FString>& outValue)
	{
