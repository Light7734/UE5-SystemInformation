...
TArray<FOperatingSystemInformation> FOperatingSystemInformationFetcher::FetchInfo()
{
	...
	TArray<FOperatingSystemInformation> operatingSystemsInfo;
	FOperatingSystemInformation operatingSystemInfo;
	...
	for (auto it : operatingSystemsQuery.GetResult())
	{
		...
		if (it.Find("Version=") == 0u)
		{
			...
			operatingSystemInfo = FOperatingSystemInformation();
		}
	}
...
void FOperatingSystemInformationFetcher::TryFetchField(const FString& iter, const char* fieldName, FString& outValue)
{
...
const char* FOperatingSystemInformationFetcher::TranslateDataExecutionPrevention_SupportPolicy(const FString& dataExecutionPrevention_SupportPolicy)
{
	try
	{
...
const char* FOperatingSystemInformationFetcher::TranslateForegroundApplicationBoost(const FString& foregroundApplicationBoost)
{
	try
	{
...
const char* FOperatingSystemInformationFetcher::TranslateProductType(const FString& productType)
{
...
void FOperatingSystemInformation::LogToUE_LOG() const
{
