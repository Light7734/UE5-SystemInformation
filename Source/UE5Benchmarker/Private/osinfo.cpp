...
std::string OSInfo::freePhysicalMemory() const
{
	...
	FSystemCommand systemCommand(FREE_PHYSICAL_MEMORY_QUERY_STRING);
...
std::string OSInfo::freeVirtualMemory() const
{
	...
	FSystemCommand systemCommand(FREE_VIRTUAL_MEMORY_QUERY_STRING);
...
std::string OSInfo::freePagingFileSpace() const
{
	...
	FSystemCommand systemCommand{ FREE_SPACE_IN_PAGING_FILES_QUERY_STRING };
...
std::string OSInfo::usedPagingFileSpace() const
{
	...
	FSystemCommand systemCommand{ USED_SPACE_IN_PAGING_FILE_QUERY_STRING };
...
std::string OSInfo::currentDateTime() const
{
	...
	FSystemCommand systemCommand{ CURRENT_DATE_TIME_QUERY_STRING };
